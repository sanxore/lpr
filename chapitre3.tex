...
%    		\includegraphics[scale=0.6]{IFA_EX}
	...
	\begin{itemize}
		...
		\item L'extraction manuelle des structures de table d'un fichier PDF consomme enormement de temps et d'energie.
		\item Apres l'extraction, Il faut transformer ces trades Matrix En des trades table pour faciliter le requetage.
	\end{itemize}
