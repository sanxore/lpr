...
\cleardoublepage
	...
	\subsection{Mise en œuvre: corrélations croisées des variables exogènes}
	...
	\subsection{Mise en œuvre: calcul des composantes principales des données élaguées}
	...
	La figure \ref{fig:scatter2} ci-après présente la sortie de la matrice des corrélations croisée mais cette fois-ci entre la variable endogène et les CP.
				\begin{figure}[H]
					    		\centering
					    		\fbox{\includegraphics[width=.8\linewidth]{ch4-images/scatter2}}
